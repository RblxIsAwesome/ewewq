...
if isfunctionhooked then
    if isfunctionhooked(FireServer) or isfunctionhooked(UnreliableFireServer) or isfunctionhooked(InvokeServer) and LPH_OBFUSCATED then
        return Services.LocalPlayer:Kick("Cheez Hub | Security : You are running another script, please disable it and execute again")
    end
end
...
local Config = {
    ...
    ESP = {
        ...
        Drawing = {
            ...
            Enabled  = false,
            Thermal = true,
            FillRGB = Color3.fromRGB(255, 174, 0),
            ...
            Weapons = {
                Enabled = false, WeaponTextRGB = Color3.fromRGB(255, 174, 0),
                Outlined = false,
                Gradient = false,
                Transparency = 0,
                GradientRGB1 = Color3.fromRGB(255, 255, 255), GradientRGB2 = Color3.fromRGB(255, 174, 0),
            },
            Inventory = {
            ...
            Boxes = {
                Animate = true,
                RotationSpeed = 300,
                Gradient = false, GradientRGB1 = Color3.fromRGB(255, 174, 0), GradientRGB2 = Color3.fromRGB(0, 0, 0), 
                GradientFill = true, GradientFillRGB1 = Color3.fromRGB(255, 174, 0), GradientFillRGB2 = Color3.fromRGB(0, 0, 0), 
                Filled = {
                    Enabled = false,
                    Transparency = 0.75,
    ...
    LPH_JIT_MAX(function()
        ...
        if Game_Name == "South Bronx" then
            ...
            HideUI = LPH_NO_VIRTUALIZE(function(Title, Timing)
                ...
                textLabel.Text = '<font color="rgb(0,163,224)">Cheez</font>Hub\n' .. Title
...
do
    ...
    do -- Initalize
        ...
        local ESP = function(plr)
            ...
            local Chams = Functions:Create("Highlight", {Parent = ScreenGui, FillTransparency = 1, OutlineTransparency = 0, OutlineColor = Color3.fromRGB(255, 174, 0), DepthMode = "AlwaysOnTop"})
...
local window = library:window({name = "Cheez", suffix = "Hub", gameInfo = string.format("Cheez Hub : %s", Game_Name:lower())})
...
window:seperator({name = "World"}) do
    ...
    _FilledBoxes:colorpicker({flag = "PlayerVisuals_FilledBoxes_Color1", color = Color3.fromRGB(255, 174, 0), alpha = 0.25, callback = function(state, alpha)
    ...
    _ChamsToggle:colorpicker({flag = "PlayerVisuals_Chams_Color1", color = Color3.fromRGB(255, 174, 0), alpha = 0.8, callback = function(state, alpha)
...
button.BackgroundColor3 = Color3.fromRGB(255, 174, 0)
button.Text = "Copy"
...
button.MouseButton1Click:Connect(function()
    if setclipboard then
        setclipboard("https://discord.gg/RG8G8AKdVb")
    elseif toclipboard then
        toclipboard("https://discord.gg/RG8G8AKdVb")
    end
    button.Text = "Copied!"
end)
